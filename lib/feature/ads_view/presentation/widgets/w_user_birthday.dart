...
class WUserBirthday extends StatefulWidget {
  const WUserBirthday({super.key, required this.onPressedCancel});
  ...
  @override
  State<WUserBirthday> createState() => _WUserBirthdayState();
}

class _WUserBirthdayState extends State<WUserBirthday> {
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        LocaleKeys.enterYourDateOfBirth.tr(),
                        ...
                        if (_formKey.currentState?.validate() ?? false) {
                          context.read<UserCubit>().editUser(
                            user: UserProfileUpdateRequest(
                              birthDay: _controller.text.trim(),
                            ),
                          );
                        }
                      },
