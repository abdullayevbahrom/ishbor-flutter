...
mixin _$ServiceViewState {
 ...
 RequestStatus get status; RequestStatus get similarServiceSt; bool get isLoadingMore; ServiceModel? get service; PaginatedServiceResponse? get listService; String? get serviceId;
...
@useResult
$Res call({
 RequestStatus status, RequestStatus similarServiceSt, bool isLoadingMore, ServiceModel? service, PaginatedServiceResponse? listService, String? serviceId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( RequestStatus status,  RequestStatus similarServiceSt,  bool isLoadingMore,  ServiceModel? service,  PaginatedServiceResponse? listService,  String? serviceId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServiceViewState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( RequestStatus status,  RequestStatus similarServiceSt,  bool isLoadingMore,  ServiceModel? service,  PaginatedServiceResponse? listService,  String? serviceId)  $default,) {final _that = this;
switch (_that) {
case _ServiceViewState():
return $default(_that.status,_that.similarServiceSt,_that.isLoadingMore,_that.service,_that.listService,_that.serviceId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( RequestStatus status,  RequestStatus similarServiceSt,  bool isLoadingMore,  ServiceModel? service,  PaginatedServiceResponse? listService,  String? serviceId)?  $default,) {final _that = this;
switch (_that) {
case _ServiceViewState() when $default != null:
return $default(_that.status,_that.similarServiceSt,_that.isLoadingMore,_that.service,_that.listService,_that.serviceId);case _:
  return null;
